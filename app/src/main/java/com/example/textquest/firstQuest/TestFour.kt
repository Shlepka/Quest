...
import com.example.textquest.databinding.FragmentTestFourBinding
...
class TestFour : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding= FragmentTestFourBinding.inflate(layoutInflater,container,false)
        return binding.root
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.button.setOnClickListener {
            ...
            MAIN.navController.navigate(R.id.action_testFour_to_testFive)
